...
MAIN_URL = "https://www.docker.com/pricing/faq/"
SITE_NAME = "DOCKER"
                    ...
                    if any(phrase in closest_txt for phrase in forbidden_phrases):
                        ...
                        for p in all_parents[-2:]:
                            ...
                            if txt and not any(phrase in txt_lower for phrase in forbidden_phrases) \
                               and "docker plans faqs" not in txt_lower:
                                titles.append(txt)
...
def run_docker(driver):
    ...
    print(f" Finished Docker FAQ scraping ({len(data)}) rows")
